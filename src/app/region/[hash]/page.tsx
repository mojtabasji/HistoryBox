...
function CoinCount({ value, small = false }: { value: number; small?: boolean }) {
  return (
    <div
      className={`rounded-md shadow-md bg-white/80 backdrop-blur flex items-center justify-center font-semibold text-gray-700 ${small ? 'h-10 px-2 text-sm' : 'h-10 px-3 text-sm'}`}
      title={t('yourCoins')}
